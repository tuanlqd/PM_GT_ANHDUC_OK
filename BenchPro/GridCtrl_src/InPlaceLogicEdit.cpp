// InPlaceLogicEdit.cpp : implementation file
//
...
InPlaceLogicEdit::InPlaceLogicEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
InPlaceLogicEdit::~InPlaceLogicEdit()
{
}

BEGIN_MESSAGE_MAP(InPlaceLogicEdit, CEdit)
...
void InPlaceLogicEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
void InPlaceLogicEdit::OnKillFocus(CWnd* pNewWnd)
{
    CEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

void InPlaceLogicEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
    ...
    if (nChar==0x30 || nChar==0x31 || nChar==0x8)
    {
...
UINT InPlaceLogicEdit::OnGetDlgCode()
{
...
BOOL InPlaceLogicEdit::PreTranslateMessage(MSG* pMsg)
{
...
// Auto delete
void InPlaceLogicEdit::PostNcDestroy()
{
    CEdit::PostNcDestroy();
